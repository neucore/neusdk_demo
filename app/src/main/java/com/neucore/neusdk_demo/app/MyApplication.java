...
public class MyApplication extends Application
{
    ...
    IExtendCallback callback = new IExtendCallback() {
        ...
        public void onCallBack() {
             ...
             * 人脸下发 扩展【取消注释，覆盖默认实现】
             */
            //ListenerRegistry.getInstance().setExtendListener(NeulinkConst.NEULINK_BIZ_BLIB,new SampleFaceSyncListener());
            /**
             * 人脸比对 扩展【取消注释，覆盖默认实现】
             */
            //ListenerRegistry.getInstance().setExtendListener(NeulinkConst.NEULINK_BIZ_CHECK,new SampleFaceCheckListener());
            /**
             * 人脸查询 扩展【取消注释，覆盖默认实现】
             */
            //ListenerRegistry.getInstance().setExtendListener(NeulinkConst.NEULINK_BIZ_QLIB,new SampleFaceQueryListener());
